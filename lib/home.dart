...
import 'package:news_prism/model/localdb.dart';
...
class _HomeState extends State<Home> {
  ...
  void storeInBox(
      String newsHead, String newsDes, String newsImg, String newsUrl) {
    LocalDBModel db = LocalDBModel(
        newsHead: newsHead,
        newsDes: newsDes,
        newsImg: newsImg,
        newsUrl: newsUrl);
    var box = Hive.box("SavedNews");
    List savedNewsList = box.get("savednews", defaultValue: []);
    savedNewsList.add(db);
    box.put("savednews", savedNewsList);
  }
}
